...
namespace RobotController{
    class FrankaHuskyWrapper{
        ...
        private:
            ...
            pinocchio::SE3 H_ee_ref_, H_ee_init_, H_mobile_ref_, T_offset_, T_vel_;
            Vector3d ee_offset_, obj_length_global_, obj_length_local_;
            Vector3d mobile_base_center_ref_, mobile_mount_offset_body_;
            MatrixXd Adj_mat_, hGr_local_, hGr_local_Null_, hGr_local_pinv_, R_joint7_atHome_, R_joint7_atTask_;
            Matrix3d mobile_joint1_rot_init_;
            double est_time_, dt_;
            double mobile_yaw_init_, mobile_yaw_goal_, mobile_yaw_ref_;
