...
ros::Publisher ee_state_pub_, base_state_pub_, base_ref_state_pub_;
ros::Publisher mobile_tracking_error_pub_, mobile_velocity_error_pub_, mobile_desired_acc_pub_, mobile_command_pub_;
...
Eigen::VectorXd Fext_cmd_;
bool use_Fext_cmd_ = false;
